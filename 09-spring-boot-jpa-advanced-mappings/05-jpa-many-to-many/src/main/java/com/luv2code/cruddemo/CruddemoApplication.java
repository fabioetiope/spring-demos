...
public class CruddemoApplication {
	...
	private void addMoreCoursesForAStudent(AppDAO appDAO) {
		...
		Course tempCourse1 = new Course("Programming 1");
		Course tempCourse2 = new Course("Programming 2");
		...
		System.out.println("updated on DB");
	}
	...
	private void findCourseAndStudents(AppDAO appDAO) {
		...
		System.out.println("Students of the course: " + tempCourse.getStudents());
		System.out.println("DONE");
	}
